...
# 鲜艳配色方案 - 根据用户要求定制
# 更鲜艳的默认颜色配置
DEFAULT_LINE_COLOR = QColor(0, 123, 255, 255)         # 鲜艳的蓝色
DEFAULT_FILL_COLOR = QColor(255, 165, 0, 180)         # 鲜艳的橙色，提高透明度到180
DEFAULT_SELECT_LINE_COLOR = QColor(255, 255, 0, 255)  # 鲜艳的黄色
DEFAULT_SELECT_FILL_COLOR = QColor(128, 0, 128, 180)  # 鲜艳的紫色，提高透明度到180
DEFAULT_VERTEX_FILL_COLOR = QColor(0, 255, 255, 255)  # 鲜艳的青色
DEFAULT_HVERTEX_FILL_COLOR = QColor(255, 255, 0, 255) # 鲜艳的黄色（高亮顶点）
...
class Shape(object):
    ...
    def paint(self, painter):
        if self.points:
            ...
            pen.setWidth(max(1, int(round(3.8 / self.scale))))
            painter.setPen(pen)
